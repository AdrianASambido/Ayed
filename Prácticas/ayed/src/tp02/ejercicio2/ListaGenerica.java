...
public abstract class ListaGenerica<T> {
	...
	/** agrega todos los elementosdel arreglo que recibe como parametro a la lista
	public boolean agregar(Arraylist() T[]) {
	...
	/**
	 * agrega todos los elementos del arreglo
	 * que recibe como parámetro
	 * 
	 * @param elems arreglo con los elementos a agregar
	 * @return true si todos los elementos fueron agregados
	 */
	
	public abstract boolean agregar(T[] elems);
